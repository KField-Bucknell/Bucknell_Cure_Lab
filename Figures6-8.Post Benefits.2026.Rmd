...
summary(Q01_model)
Q01_drop <- drop1(Q01_model, test = "LRT") %>% print()

Anova(Q01_model, type = "3")
```
...
Q02_model <- glm(data = Q02_select, 
  ...
  stepAIC(direction = "backward")
summary(Q02_model)
Q02_drop <- drop1(Q02_model, test = "LRT") %>% print()
```
...
Q03_model <- glm(data = Q03_select, 
  ...
  stepAIC(direction = "backward")
summary(Q03_model)
Q03_drop <- drop1(Q03_model, test = "LRT") %>% print()
...
Anova(Q04_model, type = "3")
summary(Q04_model)
Q04_drop <- drop1(Q04_model, test = "LRT") %>% print()
```
...
Q05_model <- glm(data = Q05_select, 
                 5-as.numeric(Response) ~ Semester + Gender + `Race/Ethnicity`) 
Anova(Q05_model, type = "3")

summary(Q05_model)
Q05_drop <- drop1(Q05_model, test = "LRT") %>% print()
```
...
Q06_model <- glm(data = Q06_select, 
  ...
  stepAIC(direction = "backward")
summary(Q06_model)
Q06_drop <- drop1(Q06_model, test = "LRT") %>% print()
Anova(Q06_model, type=3) # shows each term in interaction
```
...
Q07_model <- glm(data = Q07_select, 
  ...
  stepAIC(direction = "backward")
summary(Q07_model)
Q07_drop <- drop1(Q07_model, test = "LRT") %>% print()
```
...
Q08_model <- glm(data = Q08_select, 
  ...
  stepAIC(direction = "backward")
summary(Q08_model)
Q08_drop <- drop1(Q08_model, test = "LRT") %>% print()
```
...
Q09_model <- glm(data = Q09_select, 
  ...
  stepAIC(direction = "backward")
summary(Q09_model)
Q09_drop <- drop1(Q09_model, test = "LRT") %>% print()
```
...
Q10_model <- glm(data = Q10_select, 
  ...
  stepAIC(direction = "backward")
summary(Q10_model)
Q10_drop <- drop1(Q10_model, test = "LRT") %>% print()
```
...
Q11_model <- glm(data = Q11_select, 
  ...
  stepAIC(direction = "backward")
summary(Q11_model)
Q11_drop <- drop1(Q11_model, test = "LRT") %>% print()
```
...
Q12_model <- glm(data = Q12_select, 
                 5-as.numeric(Response) ~ Semester + Gender * `Race/Ethnicity`)
summary(Q12_model)
Q12_drop <- drop1(Q12_model, test = "LRT") %>% print()

Anova(Q12_model, type = "3")
```
...
Q13_model <- glm(data = Q13_select, 
  ...
  stepAIC(direction = "backward")
summary(Q13_model)
Q13_drop <- drop1(Q13_model, test = "LRT") %>% print()
```
...
Q14_model <- glm(data = Q14_select, 
  ...
  stepAIC(direction = "backward")
summary(Q14_model)
Q14_drop <- drop1(Q14_model, test = "LRT") %>% print()
```
...
Q15_model <- glm(data = Q15_select, 
  ...
  stepAIC(direction = "backward")
summary(Q15_model)
Q15_drop <- drop1(Q15_model, test = "LRT") %>% print()
```
...
Q16_model <- glm(data = Q16_select, 
  ...
  stepAIC(direction = "backward")
summary(Q16_model)
Q16_drop <- drop1(Q16_model, test = "LRT") %>% print()
```
...
Q17_model <- glm(data = Q17_select, 
  ...
  stepAIC(direction = "backward")
summary(Q17_model)
Q17_drop <- drop1(Q17_model, test = "LRT") %>% print()
```
...
Q18_model <- glm(data = Q18_select, 
  ...
  stepAIC(direction = "backward")
summary(Q18_model)
Q18_drop <- drop1(Q18_model, test = "LRT") %>% print()
```
...
Q19_model <- glm(data = Q19_select, 
  ...
  stepAIC(direction = "backward")
summary(Q19_model)
Q19_drop <- drop1(Q19_model, test = "LRT") %>% print()
```
...
Q20_model <- glm(data = Q20_select, 
  ...
  stepAIC(direction = "backward")
summary(Q20_model)
Q20_drop <- drop1(Q20_model, test = "LRT") %>% print()
```
...
Q21_model <- glm(data = Q21_select, 
  ...
  stepAIC(direction = "backward")
summary(Q21_model)
Q21_drop <- drop1(Q21_model, test = "LRT") %>% print()
```
...
Q10_demo_semester <- Q10_demo_long %>%
  filter(Question %in% c('Q02', 'Q13','Q14', 'Q15', 'Q16', 'Q21'))
...
Q10_demo_none <- Q10_demo_long %>%
  filter(Question %in% c('Q03', 'Q08', 'Q09', 'Q10','Q11','Q12', 'Q17','Q18','Q19','Q20'))
...
Q10_demo_gender <- Q10_demo_long %>%
  filter(Question == 'Q01')

ggplot(Q10_demo_gender) +
  geom_bar(aes(x = Gender, fill = Response), position = 'fill', width = 0.75) +
  facet_grid(as.factor(Q10_demo_gender$Question)) +
  coord_flip() +
  ylab('Proportion') +
  xlab('Gender') +
  fill_palette(c("#21327b","#3c54cd","#6598f8","#b0cafb","#FFFEFE")) +
...
Q10_demo_all <- Q10_demo_long %>%
  filter(Question %in% c('Q04','Q05','Q06'))
ggplot(Q10_demo_all) +
  geom_bar(aes(x = Semester, fill = Response), position = 'fill', width = 0.75) +
...
```{r Interaction 04, echo=FALSE}
cat_plot(model = Q04_model, pred = 'Race/Ethnicity', modx = Gender,
              interval = TRUE, x.label = "Race/Ethnicity",  
              y.label = "Student Perceived\n Gain")
catplot04 <- cat_plot(model = Q04_model, pred = 'Race/Ethnicity', modx = Gender,
              interval = TRUE, x.label = "Race/Ethnicity",  
              y.label = "Student Perceived\n Gain")
```

```{r Interaction 05, echo=FALSE}
cat_plot(model = Q05_model, pred = 'Race/Ethnicity', modx = Gender,
              interval = TRUE, x.label = "Race/Ethnicity",  
              y.label = "Student Perceived\n Gain")
catplot05 <- cat_plot(model = Q05_model, pred = 'Race/Ethnicity', modx = Gender,
              interval = TRUE, x.label = "Race/Ethnicity",  
              y.label = "Student Perceived\n Gain")
```
...
catplot04_fixed <- catplot04 + theme(panel.grid.major = element_blank(), 
                  panel.grid.minor = element_blank(),
                  panel.background = element_blank(), 
                  axis.line = element_line(colour = "black"),
                  plot.title = element_text(size = 10, face = "plain")) +
#  scale_x_discrete(labels= c("White Students", "Other Students of Color")) +
  ylim(c(0.5, 4.0)) +
  ggtitle("Readiness for more demanding research")

catplot05_fixed <- catplot05 + theme(panel.grid.major = element_blank(), 
                  panel.grid.minor = element_blank(),
                  panel.background = element_blank(), 
                  axis.line = element_line(colour = "black"),
                  plot.title = element_text(size = 10, face = "plain")) +
#  scale_x_discrete(labels= c("White Students", "Other Students of Color")) +
  ylim(c(0.5, 4.0)) +
  ggtitle("Understanding how knowledge is constructed")
...
ggarrange(catplot04_fixed, catplot05_fixed, catplot06_fixed, ncol = 2, nrow = 2)
