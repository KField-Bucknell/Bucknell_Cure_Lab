...
```{r, echo=FALSE, warning=FALSE}
selected_binomial_model <- full_binomial_model %>%
...
```{r, echo=FALSE, warning=FALSE}
model2_201 <- glm(DFW ~ Fall_Spring * Curriculum, data = Only201_DFW, family = "binomial")
summary(model2_201)
