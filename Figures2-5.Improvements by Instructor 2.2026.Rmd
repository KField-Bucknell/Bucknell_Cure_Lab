...
compare_performance(imp_model_Q10_1, step_imp_model_Q10_1, lmer_model_Q10_1)

drop1(step_imp_model_Q10_1, test = "LRT")
```
...
lmer_model_Q10_2 <- lmer(as.numeric(Q9_2_post) ~ as.numeric(Q10_2_pre) + Instructor * Rookie + (1 | Semester), data = Q_2Clean)
...
compare_performance(imp_model_Q10_2, step_imp_model_Q10_2, lmer_model_Q10_2)

drop1(step_imp_model_Q10_2, test = "LRT")
```
...
drop1(step_imp_model_Q10_3, test = "LRT")
```
...
drop1(step_imp_model_Q10_4, test = "LRT")
car::Anova(step_imp_model_Q10_4, type = "3")
```
...
drop1(step_imp_model_Q10_5, test = "LRT")
```
...
drop1(step_imp_model_Q10_6, test = "LRT")
```
...
drop1(step_imp_model_Q10_7, test = "LRT")
```
...
drop1(step_imp_model_Q10_8, test = "LRT")
```
...
drop1(step_imp_model_Q10_9, test = "LRT")
```
...
drop1(step_imp_model_Q10_10, test = "LRT")
```
...
drop1(step_imp_model_Q10_11, test = "LRT")
```
...
drop1(step_imp_model_Q10_12, test = "LRT")
```
...
drop1(step_imp_model_Q10_13, test = "LRT")
```
...
drop1(step_imp_model_Q10_14, test = "LRT")
```
...
drop1(step_imp_model_Q10_15, test = "LRT")
```
...
drop1(step_imp_model_Q10_16, test = "LRT")
```
...
drop1(step_imp_model_Q10_17, test = "LRT")
```
...
drop1(step_imp_model_Q10_18, test = "LRT")
```
...
drop1(step_imp_model_Q10_21, test = "LRT")
```
...
drop1(step_imp_model_Q10_22, test = "LRT")
```
...
drop1(step_imp_model_Q10_23, test = "LRT")
car::Anova(step_imp_model_Q10_23, type = "3")
```
...
drop1(step_imp_model_Q10_24, test = "LRT")
```
...
drop1(step_imp_model_Q10_25, test = "LRT")
```
