...
We are going to report Chisq LRT results for all variables (no model selection) and then use an alpha cutoff of 0.05 to determine which visualizations to show.
Further reading also suggests to use an F-test for testing Gaussian glms, rather than an LRT or Chi-squared test
