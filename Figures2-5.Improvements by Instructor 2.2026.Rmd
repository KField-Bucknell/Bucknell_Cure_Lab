...
Q10Clean_withNA %>%
  select(Q10_1_pre, Q9_1_post, Instructor, Rookie, Semester) %>%
  na.omit() %>%
...
lmer_model_Q10_1 <- lmer(Q9_1_post ~ Q10_1_pre + Instructor + Rookie + (1 | Semester), data = Q_1Clean)
summary(lmer_model_Q10_1)
compare_performance(imp_model_Q10_1, lmer_model_Q10_1)

Anova(imp_model_Q10_1, type = "3", test.statistic = "F")

# Fit both models with ML
imp_model_Q10_1_ml <- gls(Q9_1_post ~ Q10_1_pre + Instructor + Rookie, data = Q_1Clean, 
                          method = "ML")
lme_model_Q10_1_ml <- lme(fixed = Q9_1_post ~ Q10_1_pre + Instructor + Rookie, 
                          random = ~ 1 | Semester, 
...
imp_model_Q10_1b <- glm(Q9_1_post ~ Q10_1_pre + Instructor + Rookie, contrasts = type3, data = Q_1Clean)
...
# Using glm() to determine if post response depends on pre response or on instructor and rookie status:
Q10Clean_withNA %>%
  select(Q10_2_pre, Q9_2_post, Instructor, Rookie, Semester) %>%
  na.omit() %>%
