...
## -2.7944 -0.6169  0.1915  0.7220  1.7295 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  Semester (Intercept) 0.02897  0.1702  
##  Residual             1.09137  1.0447  
## Number of obs: 215, groups:  Semester, 6
## 
## Fixed effects:
##                                     Estimate Std. Error t value
## (Intercept)                         3.768100   0.441051   8.543
## Q10_1_pre                           0.119398   0.088419   1.350
## InstructorHagrid                   -0.675546   0.463387  -1.458
## InstructorLupin                    -0.321811   0.442292  -0.728
## InstructorMcGonagall               -0.391218   0.469532  -0.833
## InstructorSinistra                 -0.512692   0.513338  -0.999
## RookieVeteran                      -0.452685   0.378821  -1.195
## InstructorHagrid:RookieVeteran     -0.005965   0.572847  -0.010
## InstructorLupin:RookieVeteran       0.043809   0.558019   0.079
## InstructorMcGonagall:RookieVeteran  0.445971   0.569576   0.783
## InstructorSinistra:RookieVeteran    0.549264   0.560323   0.980
## 
## Correlation of Fixed Effects:
##             (Intr) Q10_1_ InstrH InstrL InstMG InstrS RkVtrn InH:RV InL:RV
## Q10_1_pre   -0.648                                                        
## InstrctrHgr -0.565  0.019                                                 
## InstrctrLpn -0.357 -0.114  0.407                                          
## InstrctrMcG -0.418  0.020  0.386  0.402                                   
## InstrctrSns -0.475 -0.037  0.596  0.374  0.348                            
## RookieVetrn -0.657 -0.029  0.643  0.504  0.471  0.582                     
## InstrctH:RV  0.498 -0.078 -0.810 -0.322 -0.314 -0.480 -0.652              
## InstrctL:RV  0.262  0.122 -0.322 -0.796 -0.318 -0.298 -0.490  0.309       
## InstrcMG:RV  0.369 -0.054 -0.209 -0.327 -0.825 -0.186 -0.529  0.261  0.317
## InstrctS:RV  0.445  0.019 -0.546 -0.341 -0.319 -0.916 -0.650  0.540  0.320
##             IMG:RV
## Q10_1_pre         
## InstrctrHgr       
## InstrctrLpn       
...
## ---------------------------------------------------------------------------
## imp_model_Q10_1  |     glm | 643.2 (0.903) |  644.7 (0.914) | 683.6 (0.980)
## lmer_model_Q10_1 | lmerMod | 647.6 (0.097) |  649.5 (0.086) | 691.5 (0.020)
## 
## Name             |  RMSE | Sigma |    R2 | R2 (cond.) | R2 (marg.) |   ICC
## --------------------------------------------------------------------------
## imp_model_Q10_1  | 1.021 | 1.048 | 0.060 |            |            |      
## lmer_model_Q10_1 | 1.015 | 1.045 |       |      0.080 |      0.056 | 0.026
```
...
## Name                 |   Model | AIC (weights) | AICc (weights) | BIC (weights)
## -------------------------------------------------------------------------------
## imp_model_Q10_1      |     glm | 643.2 (0.064) |  644.7 (0.043) | 683.6 (<.001)
## step_imp_model_Q10_1 |     glm | 637.9 (0.929) |  638.6 (0.953) | 664.8 (>.999)
## lmer_model_Q10_1     | lmerMod | 647.6 (0.007) |  649.5 (0.004) | 691.5 (<.001)
## 
## Name                 |  RMSE | Sigma |    R2 | R2 (cond.) | R2 (marg.) |   ICC
## ------------------------------------------------------------------------------
## imp_model_Q10_1      | 1.021 | 1.048 | 0.060 |            |            |      
## step_imp_model_Q10_1 | 1.028 | 1.045 | 0.048 |            |            |      
## lmer_model_Q10_1     | 1.015 | 1.045 |       |      0.080 |      0.056 | 0.026
```
...
##    Data: Q_2Clean
## 
## REML criterion at convergence: 609.8
## 
## Scaled residuals: 
##     Min      1Q  Median      3Q     Max 
## -2.8897 -0.6472  0.2724  0.4461  1.9790 
## 
## Random effects:
##  Groups   Name        Variance Std.Dev.
##  Semester (Intercept) 0.0000   0.0000  
##  Residual             0.9873   0.9936  
## Number of obs: 215, groups:  Semester, 6
## 
## Fixed effects:
##                                    Estimate Std. Error t value
## (Intercept)                         3.97313    0.36224  10.968
## as.numeric(Q10_2_pre)              -0.08628    0.08212  -1.051
## InstructorHagrid                   -0.14644    0.37070  -0.395
## InstructorLupin                     0.42369    0.40284   1.052
## InstructorMcGonagall               -0.04614    0.44229  -0.104
## InstructorSinistra                 -0.14914    0.42462  -0.351
## RookieVeteran                      -0.01550    0.29916  -0.052
## InstructorHagrid:RookieVeteran     -0.51879    0.45848  -1.132
## InstructorLupin:RookieVeteran      -0.68748    0.51255  -1.341
## InstructorMcGonagall:RookieVeteran  0.00472    0.50451   0.009
## InstructorSinistra:RookieVeteran    0.17970    0.46754   0.384
## 
## Correlation of Fixed Effects:
##             (Intr) a.(Q10 InstrH InstrL InstMG InstrS RkVtrn InH:RV InL:RV
## as.(Q10_2_) -0.680                                                        
## InstrctrHgr -0.465 -0.089                                                 
## InstrctrLpn -0.408 -0.111  0.482                                          
## InstrctrMcG -0.377 -0.093  0.438  0.406                                   
## InstrctrSns -0.444 -0.021  0.450  0.415  0.377                            
## RookieVetrn -0.608 -0.062  0.641  0.592  0.539  0.556                     
## InstrctH:RV  0.396  0.043 -0.806 -0.387 -0.352 -0.363 -0.653              
## InstrctL:RV  0.262  0.173 -0.386 -0.795 -0.327 -0.328 -0.592  0.387       
## InstrcMG:RV  0.347  0.057 -0.382 -0.353 -0.874 -0.330 -0.594  0.388  0.355
## InstrctS:RV  0.417  0.000 -0.407 -0.374 -0.341 -0.908 -0.637  0.416  0.372
##             IMG:RV
## as.(Q10_2_)       
## InstrctrHgr       
## InstrctrLpn       
...
## Name                 |   Model | AIC (weights) | AICc (weights) | BIC (weights)
## -------------------------------------------------------------------------------
## imp_model_Q10_2      |     glm | 620.1 (0.018) |  621.6 (0.009) | 660.6 (<.001)
## step_imp_model_Q10_2 |     glm | 612.1 (0.976) |  612.1 (0.989) | 618.8 (>.999)
## lmer_model_Q10_2     | lmerMod | 622.1 (0.007) |  623.9 (0.003) | 665.9 (<.001)
## 
## Name                 |  RMSE | Sigma |        R2 | R2 (cond.) | R2 (marg.)
## --------------------------------------------------------------------------
## imp_model_Q10_2      | 0.968 | 0.994 |     0.054 |            |           
## step_imp_model_Q10_2 | 0.995 | 0.998 | 5.551e-16 |            |           
## lmer_model_Q10_2     | 0.968 | 0.994 |           |            |      0.052
```
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 4-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 23-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 1-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 8-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 10-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Interaction 13-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Combined Interaction Plots-1.png)<!-- -->
...
![](Figures2-5.Improvements-by-Instructor-2.2026_files/figure-html/Only Interact Plots-1.png)<!-- -->
